...
/// <summary>
/// Extension methods for LocalStorageService to manage favorite recipes.
/// </summary>
public static class FavoritesExtensions
{
    ...
    /// </summary>
    public static async Task<List<int>> GetFavoritesAsync(this LocalStorageService localStorage)
    {
    ...
    /// </summary>
    public static async Task<bool> IsFavoriteAsync(this LocalStorageService localStorage, int recipeId)
    {
    ...
    /// </summary>
    public static async Task ClearFavoritesAsync(this LocalStorageService localStorage)
    {
    ...
    /// </summary>
    public static async Task<int> GetFavoritesCountAsync(this LocalStorageService localStorage)
    {
        var favorites = await localStorage.GetFavoritesAsync();
